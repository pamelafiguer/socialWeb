...
<head>
    ...
    <link rel="{{ asset ('css/estilos.css')}}" href="style.css">
</head>
<body>
    ...
    <div class="container">
        <div class="titulo">
            <h1> REGISTRO </h1>
            <div class="subtitulo">
                <p> Bienvenido, para ingresar llenar tus nuevos datos </p>
            </div>
            <div class="nombres">
            ...
            <div class="fecha_nacimiento">
                <label for="day">Dia:
                    <select name="birthday_day" id="dia">
                ...
                <label for="Month">Mes:
                    <select name="birthday_month" id="mes">
                        <option value="Enero">Enero</option>
                        <option value="Enero">Febreo</option>
                ...
                <label for="Year">Año:
                    <select name="bithday_year" id="year">
